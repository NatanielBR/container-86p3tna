...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-86p3tna.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-86p3tna.containers.anotherwebservice.com/
...
```
git clone git@github.com:NatanielBR/container-86p3tna.git
cd container-86p3tna
```
...
```
docker attach container-86p3tna
```
